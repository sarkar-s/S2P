...
if __name__ == '__main__':
    ...
    for file_no in range(0,samples):
        try:
            ...
            chainstats_file = open('diffusivity'+str(file_no)+'.csv','r')
    ...
    outfile = open('diffusion_summary.csv','w')
    
    print >> outfile, 'Time,DC,Network Size,Molecule Diffusivity,Network Diffusivity'
