...
def extract_data_set(filename):
    ...
    labels = ['Radial distance','Node','Junction']
    data_values = {}
    data_x = {}
...
if __name__ == '__main__':
    ...
    for file_no in range(0,samples):
        try:
            correlation_file = open('pcvar_final_'+str(file_no)+'.csv','r')
    ...
    outfile = open('pcvar_final_summary.csv','w')
    ...
    for file_no in range(0,samples):
        try:
            correlation_file = open('pcvar_light_off_'+str(file_no)+'.csv','r')
    ...
    outfile = open('pcvar_light_off_summary.csv','w')
